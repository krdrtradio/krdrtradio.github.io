...
async function WPCustomList(mainUrl, siteKey, typeName, typeCat, categoryID = null, year = null, month = null, day = null, is_categories = true, is_image = true, append = false) {
    ...
    try {
        ...
        if (button) {
            ...
            button.onclick = () => {
                ...
                WPCustomList(mainUrl, siteKey, typeName, typeCat, categoryID, year, month, day, is_categories, is_image, true);
            };
        }
    } catch (error) {
        console.error(error);
