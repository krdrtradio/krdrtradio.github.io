...
async function WPArticleList(mainUrl, siteKey, type = 'post', search = null, categoryID = null, categoryExID = null, categoryOperator = null, categoryChildren = true, tagID = null, tagExID = null, tagOperator = null, authorID = null, authorExID = null, year = null, month = null, day = null, is_categories = true, is_author = true, is_image = true, append = false) {
    ...
    try {
        ...
        const postsHTML = posts.map(post => {
            ...
            <article class="article_post">
                ...
                <div class="article_content">
                    ...
                    <div class="article_title">
                        <a href="https://krdrtradio.github.io/media/article?id=${post.slug}&si=${siteKey}" target="_blank">${title || '{Brak tytułu}'}</a>
                    </div>
        ...
        if (button) {
            ...
            button.disabled = false;
            button.style.display = posts.length < perPage ? 'none' : 'block';
            button.onclick = () => WPArticleList(mainUrl, siteKey, type, search, categoryID, categoryExID, categoryOperator, categoryChildren, tagID, tagExID, tagOperator, authorID, authorExID, year, month, day, is_categories, is_author, is_image, true);
        }
    } catch (error) {
        console.error(error);
